...
function App(activity){
    ...
    const status = 
    //activity.status == 'not-approved' ? 
    ()=>window.location.href = `./EventAttendance/${activity.id}` 
    //: "";
    ...
    <tr >
      ...
      <td  className="Table__data">
        ...
        <button className="delete-button DeleteButton" onClick={() => {activity.handleUpdate(activity.id)}}>✎</button>
