...
module.exports = (app) => {
  ...
  router.get("/sortByID", student.sortByID);
  router.get("/", student.findAll);
  router.get("/getEvents/:id", student.getEventsByID);
  ...
  router.get("/sortByLastName", student.sortByLastName);
  //router.get("/sortByIdEvent/:id", student.sortByIDEvent);
  //router.get("/sortByFirstNameEvent/:id", student.sortByFirstNameEvent);
